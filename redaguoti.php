            ...
            <td>
                ...
                ?>
                    <div class="container" style="padding: 5%;">
                        <h1 style="color: #343a40">Redaguoti įrankį</h1>
                        <form action=update.php method=post>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4">Irankio pavadinimas</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="bukle" value="<?php echo $row['bukle'] ?>" class="form-control" id="inputPassword4" required>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputAddress">Kaina</label>
                                    <input type="text" name="kaina" value="<?php echo $row['kaina'] ?>" class="form-control" id="inputAddress" required>
                                </div>
                            </div>
                            <div class="form-row ">
                                <div class="form-group col-md-6">
                                    <label for="inputAddress2">Tipas</label>
                                    <input type="text" name="tipas" value="<?php echo $row['tipas'] ?>" class="form-control" id="inputAddress2" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputCity">Klasė</label>
                                    <input type="text" name="klase" value="<?php echo $row['klase'] ?>" class="form-control" id="inputCity" required>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="inputCity">Prieinamumas</label>
                                    <input type="text" name="prieinamumas" value="<?php echo $row['prieinamumas'] ?>" class="form-control" id="inputCity" required>
                                </div>
                            </div>
